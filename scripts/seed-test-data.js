...
const USERS = [
  { name: 'Admin Alpha', email: 'seed.admin.alpha@crossapp.test', role: 'ADMIN', boxes: ['alpha'] },
  { name: 'Coach Alpha', email: 'seed.coach.alpha@crossapp.test', role: 'COACH', boxes: ['alpha'] },
  { name: 'Aluno A1', email: 'seed.aluno.a1@crossapp.test', role: 'ALUNO', boxes: ['alpha'] },
  { name: 'Aluno A2', email: 'seed.aluno.a2@crossapp.test', role: 'ALUNO', boxes: ['alpha'] },
  { name: 'Aluno A3', email: 'seed.aluno.a3@crossapp.test', role: 'ALUNO', boxes: ['alpha', 'bravo'] },
  { name: 'Admin Bravo', email: 'seed.admin.bravo@crossapp.test', role: 'ADMIN', boxes: ['bravo'] },
  { name: 'Coach Bravo', email: 'seed.coach.bravo@crossapp.test', role: 'COACH', boxes: ['bravo'] },
  { name: 'Aluno B1', email: 'seed.aluno.b1@crossapp.test', role: 'ALUNO', boxes: ['bravo', 'alpha'] },
  { name: 'Aluno B2', email: 'seed.aluno.b2@crossapp.test', role: 'ALUNO', boxes: ['bravo'] },
];
