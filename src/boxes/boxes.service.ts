...
export class BoxesService {
  ...
  async register(registerBoxDto: RegisterBoxDto) {
    ...
    const box: Box = {
      ...
      contactPhone: registerBoxDto.contactPhone,
      contactEmail: registerBoxDto.contactEmail,
      contactWhatsapp: registerBoxDto.contactWhatsapp,
      contactInstagram: registerBoxDto.contactInstagram,
      contactWebsite: registerBoxDto.contactWebsite,
      address: registerBoxDto.address,
      createdAt: new Date(),
    };
